<?php
class Csppdf extends CI_Controller
{
	public function __construct()
	{
		...
		$this->data = array(
            'title' => 'Chedpdf - Brainworld Store',
			'chedpdfclass' => 'active',
		);
	...
	public function index(){
		...
		$dob = '09/05/1999';
		$pob = 'Guesang, Mangaldan, Pangasinan';
		$sex = 'Male';
		$civilStatus = 'Single';
		$citizenship = 'Filipino';
		$mobileNo = '0987-093-9876';
		$email = 'daniel@gmail.com';
		$schoolSector = 'Public';
		$highestAttained = 'High School Graduate';

		// PRESENT ADDRESS
		$presentAddress = '434-Brgy. Guesang, Mangaldan, Pangasinan';
		$presentZip = '2432';

		// PRESENT ADDRESS
		$permanentAddress = '434-Brgy. Guesang, Mangaldan, Pangasinan';
		$permanentZip = '2432';

		$schoolLastAttended = 'Don Mariano Marcos Memorial State University-South La Union Campus';
		$schoolLastAttendedAddress = 'Agoo, La Union';
		...
		// FATHER
		$fatherStatus = 'Living';
		$fatherName = 'Renato Padilla';
		$fatherAddress = 'Guesang, Mangaldan, Pangasinan';
		$fatherContactNo = '0986-799-0893';
		$fatherOccupation = 'Company Manager';
		$fatherEmployer = 'Mr. Pascual Cruz';
		$fatherEmployerAddress = 'Guesang, Mangaldan, Pangasinan';
		$fatherAttained = 'College Graduate';
		$fatherIncome = '50,000 per month';

		// MOTHER
		$motherStatus = 'Living';
		$motherName = 'Marinette Padilla';
		$motherAddress = 'Guesang, Mangaldan, Pangasinan';
		$motherContactNo = '0923-259-2523';
		$motherOccupation = 'English Head Teacher';
		$motherEmployer = 'Mrs. Selvia Lustre';
		$motherEmployerAddress = 'Guesang, Mangaldan, Pangasinan';
		$motherAttained = 'Master Graduate';
		$motherIncome = '30,000 per month';

		// GUARDIAN
		$guardianStatus = 'Living';
		$guardianName = 'Marites Villanueva';
		$guardianAddress = 'Guesang, Mangaldan, Pangasinan';
		$guardianContactNo = '0973-023-6389';
		$guardianOccupation = 'Computer Shop Manager';
		$guardianEmployer = 'Mrs. Selena Macaraeg';
		$guardianEmployerAddress = 'Guesang, Mangaldan, Pangasinan';
		$guardianAttained = 'College Graduate';
		$guardianIncome = '20,000 per month';

		$noOfSiblings = '3';

		$isDSWDBen = 'No';

		$schoolIntendedToEnroll = 'Don Mariano Marcos Memorial State University-Mid La Union Campus';
		$schoolIntendedToAddress = 'San Fernando City, La Union';
		$schoolIntendedType = 'Public';
		...
		$enjoyingOtherSources = 'Yes';

		$firSourceType = 'Sponsorship';
		$firSourceAgency = 'Joe De Venecia';
		$secSourceType = 'Schoolarship Grant';
		$secSourceAgency = 'Department of Science and Technology';
...
// CHEDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDD
		...
		$seniorCitizen = 'Yes';
		$withDisability = 'Yes';
		$studDisability = 'Deaf or hard of hearing';
		$indigenous = 'Yes';
		$indigenousGroup = 'Ifugao';
		...
		$ips = 'Yes';
		$pwd = 'Yes';
		$chedStuf = 'Mr. Elvin Estoque Casem';
		$date =  date('M d, Y');
		

		// CONDITIONS
		if($soloParent == 'Yes') $soloParentCHK = 'checked';
		if($seniorCitizen == 'Yes') $seniorCitizenCHK = 'checked';
		if($withDisability == 'Yes') $withDisabilityCHK = 'checked';
		if($studDisability == '') $studDisability = '__________'; else $studDisability = '<u>'.$studDisability.'</u>';
		if($indigenous == 'Yes') $indigenousCHK = 'checked';
...
// END CHEDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDD
		...
		$html_content =$this->load->view('Chedpdf/csppdf_view',$this->data, true);
		// $html_content .= strlen($mname).'aasdsa';
		$html_content .= '
		<div>
			<b><i><font style="font-size: 7.5pt;">Revised StuFAPs FORM NO. 1<br>2019 version </font><font style="30pt;">(NOT FOR SALE)</font></i></b>
			...
			<div style="margin-top: 20px; margin-left: 40px; width: 132px; height: 132px; margin-right: 3px;"><img src="public/img/ched-logo-1-292x300.png" height="70px;"></div>
			...
			<div style="margin-top: 10px; margin-left: 30px; margin-right: 3px; font-family: Century Gothic, sans-serif; font-size: 11pt;"><center><b>CHED SCHOLARSHIP PROGRAM (CSP)<br><font style="font-size: 12pt;">APPLICATION FORM</font></b></center></div>
		</div>
        ...
        <table class="b" style="border-collapse: collapse;border-left: none; border-right: none;">
            ...
            <tbody>';
        $html_content .= '<tr>
	        				<td colspan="7" style="border-top: 2px solid black; border-right: 2px solid black;" ><b>CRITERIA OF ELIGIBILITY per  CMO______ s. 2019</b>
	        				...
	        				<td colspan="6" style="border-top: 2px solid black;" width="75%"><b>DOCUMENTARY REQUIREMENTS  per  CMO______ s. 2019</b>
        				...
        				<tr><td colspan="13" style="border-top: 1px solid black"><b>NOTE:  Beneficiaries of free higher education under RA 10931 can only receive stipend under this program</b></td></tr>
        				...
        				<tr>
        					...
        					<td colspan="4" style="border-bottom: 1px solid black; border-right: 2px solid black '.$motherAddressFont.'" class="input">'.$guardianAddress.'</td>
