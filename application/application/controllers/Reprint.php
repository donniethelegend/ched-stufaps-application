...
class Reprint extends CI_Controller
{
	...
	{
		parent::__construct();
		$this->load->model('applicantprofile_model');
	...
	public function index()
	{
		...
		//$data['loginstatus'] = 1;//$this->onlineapplication_model->city_municipality();
		
		//$data['city_municipality'] = $this->onlineapplication_model->city_municipality();

		$this->load->view('scholarshipapplication/reprint_view',$data);
	...
	private function loginapplicant($applicantid,$firstname,$lastname,$dateofbirth){
		
		$this->applicantprofile_model->loginapplicant($applicantid,$firstname,$lastname,$dateofbirth);
	...
	public function reprintapplication()
	{
		...
		$mobileno1 = $this->input->post('mno');
		$mobileno2 = $this->input->post('mno2');
		//$applicationid = "52562";
		//$mobileno1 = "63946";
	//	$mobileno2 = "8147457";
	...
	//	print_r($fulldetails);
		...
		if($fulldetails==null){
			...
			header("Location: ". base_url() ."reprint");
		}
