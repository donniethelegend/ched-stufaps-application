...
class Enrolmentbycongdistrict extends CI_Controller
{
	...
	public function __construct()
	{
		...
		$this->load->model('centraloffice_model');
		  $this->data = array(
            'title' => 'Enrolment by Congressional District per Region',
			'heiclass' => '',
			'heilist' => '',
			'programlist' => '',
			'deanslist' => '',
			...
			'facultyclass' => '',
			'programclass' => '',
			'enrolmentclass' => 'active',
			'graduateclass' => '',
			'breadcrumb' =>array('bc'=>"Home")
			);
			$this->js = array(
            'jsfile' => 'central_enrolment_bycongdistrict.js'
			);
	...
	public function index()
	{
		...
		$data['totalenrolmentbyprogramlevel'] = json_encode($this->centraloffice_model->totalenrolmentbycongdistrict($currentay,$currentregion,$programlevel));
		
		$data['totalenrolmentbyprogramlevel_table'] = $this->centraloffice_model->totalenrolmentbycongdistrict($currentay,$currentregion,$programlevel);
		...
		$this->load->view('central_office/enrolmentbycongdistrict_view',$data);
