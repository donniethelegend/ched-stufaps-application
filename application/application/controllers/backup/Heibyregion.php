...
class Heibyregion extends CI_Controller
{
	...
	public function index()
	{
		...
		$data['totalheiperregion_table'] = $this->centraloffice_model->totalheiperregion_table();
		//print_r($data['totalheiperregion']);
		$this->load->view('central_office/heibyregion_view',$data);
