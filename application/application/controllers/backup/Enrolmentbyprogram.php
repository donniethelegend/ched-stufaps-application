...
class Enrolmentbyprogram extends CI_Controller
{
	...
	public function __construct()
	{
		...
		$this->load->model('centraloffice_model');
		  $this->data = array(
			...
			$this->js = array(
            'jsfile' => 'central_enrolment_byprogram.js'
			);
	...
	public function index()
	{
		...
		$data['totalenrolmentbyprogramlevel'] = json_encode($this->centraloffice_model->totalenrolmentbyprogramlevel($currentay,$currentregion,$programlevel));
		...
		$this->load->view('central_office/enrolmentbyprogram_view',$data);
