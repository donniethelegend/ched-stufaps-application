...
class Enrolmentbydiscipline extends CI_Controller
{
	...
	public function __construct()
	{
		...
		$this->load->model('centraloffice_model');
		  $this->data = array(
            'title' => 'Enrolment by Discipline per Region',
			'heiclass' => '',
			'heilist' => '',
			'programlist' => '',
			'deanslist' => '',
			...
			$this->js = array(
            'jsfile' => 'central_enrolment_bydiscipline.js'
			);
	...
	public function index()
	{
		...
		$data['totalenrolmentbyprogramlevel'] = json_encode($this->centraloffice_model->totalenrolmentbydiscipline($currentay,$currentregion,$programlevel));
		
		$data['totalenrolmentbyprogramlevel_table'] = $this->centraloffice_model->totalenrolmentbydiscipline($currentay,$currentregion,$programlevel);
		...
		$this->load->view('central_office/enrolmentbydiscipline_view',$data);
