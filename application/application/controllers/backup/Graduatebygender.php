...
class Graduatebygender extends CI_Controller
{
	...
	public function __construct()
	{
		...
		$this->load->model('centraloffice_model');
		  $this->data = array(
            'title' => 'Graduate by Region (Gender)',
			'heiclass' => '',
			'heilist' => '',
			'programlist' => '',
			'deanslist' => '',
	...
	public function index()
	{
		...
		$data['totalmale'] = json_encode($this->centraloffice_model->totalmalegraduate($currentay,$programlevel));
		$data['totalfemale'] = json_encode($this->centraloffice_model->totalfemalegraduate($currentay,$programlevel));
		
		
		//table query
		$data['totalenrolmentbygender'] = $this->centraloffice_model->totalenrolmentbygender_table();
		//print_r($data['totalheiperregion']);
		$this->load->view('central_office/graduatebygender_view',$data);
