...
class Scholarshipapplicants extends CI_Controller
{
	...
	public function search()
	{
		...
		//$data['contact_list'] = $this->contacts_model->get();
		//$data['hei_list'] = $this->contacts_model->gethei();
		$data['applicants_list'] = $this->scholarshipapplicants_model->getsearch($keyword);
		$data['hei_list'] = $this->scholarshipapplicants_model->gethei();
		$data['courses_list'] = $this->scholarshipapplicants_model->getcourses();
		$data['user_count'] = $this->scholarshipapplicants_model->getusercount();
		$data['yearapplied_list'] = $this->scholarshipapplicants_model->getyearapplied();
	...
	public function csp()
	{
		...
		$currentm = date('m',$currenttime);
		$congdistrict ="All";
		header('Location: ../scholarshipapplicants/cspabove/'.$currenty);

	}
	
	public function cspabove($year)
	{
		...
		*/
		$data['page'] = "cspabove";
		$data['details'] =array('instname'=>"Applicants List") ;
		$data['applicants_list'] = $this->scholarshipapplicants_model->getcspabove($year);
		//print_r($data['user_count']);
		$data['scholarshipapplicant'] = '';
		$data['cspabove'] = 'active';
		$this->load->view('inc/header_view');
		$this->load->view('scholarship/cspabove_view',$data);
		$this->load->view('inc/footer_view',$js);
		
	}
	
	public function cspabovejson()
	{
		...
		$csparray = $this->scholarshipapplicants_model->cspabovejson("2019");
	...
	public function ctdp()
	{
		...
		$currentm = date('m',$currenttime);
		$congdistrict ="All";
		header('Location: ../scholarshipapplicants/ctdpbelow/'.$currenty);

	}
	
	public function ctdpbelow($year)
	{
		...
		$data['page'] = "ctdpbelow";
		$data['details'] =array('instname'=>"Applicants List") ;
		//$data['applicants_list'] = $this->scholarshipapplicants_model->getctdpbelow($year);
		//print_r($data['user_count']);
		$data['scholarshipapplicant'] = '';
		$data['ctdpbelow'] = 'active';
		$this->load->view('inc/header_view');
		$this->load->view('scholarship/ctdpbelow_view',$data);
		$this->load->view('inc/footer_view',$js);
		
	}
	
	public function ctdpbelowjson()
	{
		...
		$csparray = $this->scholarshipapplicants_model->getctdpbelow("2019");
