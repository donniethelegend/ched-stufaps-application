...
class Graduatebycongdistrict extends CI_Controller
{
	...
	public function __construct()
	{
		...
		$this->load->model('centraloffice_model');
		  $this->data = array(
            'title' => 'Graduate by Congressional District per Region',
			'heiclass' => '',
			'heilist' => '',
			'programlist' => '',
			'deanslist' => '',
	...
	public function index()
	{
		...
		$data['totalenrolmentbyprogramlevel'] = json_encode($this->centraloffice_model->totalgraduatebycongdistrict($currentay,$currentregion,$programlevel));
		
		$data['totalenrolmentbyprogramlevel_table'] = $this->centraloffice_model->totalgraduatebycongdistrict($currentay,$currentregion,$programlevel);
		...
		$this->load->view('central_office/graduatebycongdistrict_view',$data);
