...
class Graduatebyprogram extends CI_Controller
{
	...
	public function index()
	{
		...
		$data['totalenrolmentbyprogramlevel'] = json_encode($this->centraloffice_model->totalgraduatebyprogramlevel($currentay,$currentregion,$programlevel));
		...
		$this->load->view('central_office/graduatebyprogram_view',$data);
