...
<!--  Row -->
	...
	<div class="row">
						...
						echo "<td class='text-center'><a class='btn btn-effect-ripple btn-sm btn-primary' href='".$baseurl."batchvoucher/printvoucher/".$vlist['voucherid']."' target='_blank'><i class='fa fa-print'></i></a><a href='#' data-toggle='tooltip' title='Cancel Voucher' class='btn btn-effect-ripple btn-sm btn-danger' ><i class='fa fa-times'></i></a> </td>";
						echo "</tr>";
