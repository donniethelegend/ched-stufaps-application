...
<div id="page-content">
	...
	<div class="block full">
		...
		<div class="form-group">
			...
			<div class="col-sm-4">
				<input type="text" class="form-control" id="mainprogram" placeholder="" value="<?php echo $details['mainprogram'];?>">
			</div>
			
			<label class="col-sm-2 control-label" for="example-input-large">Program Code</label>
			<div class="col-sm-4">
				<select id="mpcode" name="example-select2" class="select-select2" style="width: 100%;" data-placeholder="Choose one..">
					<!--<option value="<?php echo $details['mpcode'];?>"><?php echo $details['mpcode'];?></option> Required for data-placeholder attribute to work with Select2 plugin -->
					<?php
						foreach($discipline_specific_list as $discipline_specific):
						
						if($details['mpcode']==$discipline_specific['specificcode']){
							$selected_pcode = "selected='selected'";
						}else{
							$selected_pcode = "";
						}
						echo "<option value='".$discipline_specific['specificcode']."' $selected_pcode>".$discipline_specific['specificcode']." - ".$discipline_specific['majordisciplinename']." (".$discipline_specific['specificdisciplinename'].")</option>";
						endforeach;
					?>
			...
			<!--<div class="col-sm-2">
				<input type="text" class="form-control" id="mpcode" value="<?php //echo $details['mpcode'];?>">
			...
			<div class="col-sm-4">
				<input type="text" class="form-control" id="major" value="<?php echo $details['major'];?>">
			</div>
			
			<label class="col-sm-2 control-label" for="example-input-large">Major Code</label>
			<div class="col-sm-4">
				<select id="mjcode" name="example-select2" class="select-select2" style="width: 100%;" data-placeholder="Choose one..">
					<!-- <option value="<?php echo $details['mjcode'];?>"><?php echo $details['mjcode'];?></option> Required for data-placeholder attribute to work with Select2 plugin -->
					<?php
						foreach($discipline_specific_list as $discipline_specific):
						
						if($details['mjcode']==$discipline_specific['specificcode']){
							$selected_mcode = "selected='selected'";
						}else{
							$selected_mcode = "";
						}
							echo "<option value='".$discipline_specific['specificcode']."' $selected_mcode>".$discipline_specific['specificcode']." - ".$discipline_specific['majordisciplinename']." (".$discipline_specific['specificdisciplinename'].")</option>";
						endforeach;
					?>
			...
			<div class="col-sm-4">
				<select id="discipline" name="example-select2" class="select-select2" style="width: 100%;" data-placeholder="Choose one..">
					...
					<?php
						foreach($discipline_list as $disciplines):
						
						if($details['discipline'] == $disciplines['groupcode']){
							$selected_disc = "selected='selected'";
						}else{
							$selected_disc = "";
						}
							echo "<option value='".$disciplines['groupcode']."' $selected_disc>".$disciplines['groupcode']." - ".$disciplines['discipline_description']."</option>";
						endforeach;
					?>
			...
			<div class="col-sm-4 hidden">
				<select id="discipline2" name="example-select2" class="select-select2" style="width: 100%;" data-placeholder="Choose one..">
			...
			<div class="col-sm-2">
				...
				<select class="form-control"  id="authcat">
					<option value="<?php echo $details['authcat'];?>"><?php echo $details['authcat'];?></option>
					<?php
						foreach ($permit_category_list as $catlist):
							echo "<option value='".$catlist['permitcategory']."'>".$catlist['permitcategory']." - ". $catlist['permitdescription']. "</option>";
						endforeach;
					?>
			...
			<div class="col-sm-2">
				<input type="text" class="form-control" id="authserial" placeholder="Serial" value="<?php echo $details['authserial'];?>">
			</div>
			<div class="col-sm-2">
				<input type="text" class="form-control" id="authyear" placeholder="Year" value="<?php echo $details['authyear'];?>">
			</div>
			...
			<label class="col-sm-2 control-label" for="example-input-large">Program Mode (if OT)</label>
			<div class="col-sm-2">
				<input type="text" id="pmif" class="form-control" value="<?php echo $details['pmif'];?>">
			</div>
		...
		<!-- Block Tabs -->
                                <div class="block full">
                                    ...
                                    <div class="block-title">
                                        <div class="pull-right">
											...
											<a href="#modal-regular" data-toggle="modal" class="btn btn-effect-ripple btn-primary" >School Year</a>
                                        </div>
                                    ...
                                    <div class="tab-content">
										...
										<a href="../getenrolment/<?php echo $programid;?>" class="btn btn-effect-ripple btn-success" data-toggle="modal" target="_blank"><i class="hi hi-download-alt"></i> Download Enrolment</a>
            ...
            <table id="example-datatable" class="table table-striped table-bordered table-vcenter table-hover">
				...
				echo "<td><button  onclick='deleteenrolment(".$elist['programenrolmentid'].");' type='reset' class='btn btn-effect-ripple btn-danger' title='Delete collection'><i class='fa fa-times'></i></button><button  class='btn btn-primary' title='Save' onClick='updateenr(".$elist['programenrolmentid'].")'><i class='gi gi-floppy_saved'></i></button></td>";
				...
				?>
										...
										<a href="../getgraduate/<?php echo $programid;?>" class="btn btn-effect-ripple btn-success" data-toggle="modal" target="_blank"><i class="hi hi-download-alt"></i> Download Graduate</a>
            ...
            <table id="example-datatable2" class="table table-striped table-bordered table-vcenter table-hover">
				...
				echo "<td><button  onclick='deletegraduate(".$glist['programgraduateid'].");' type='reset' class='btn btn-effect-ripple btn-danger' title='Delete collection'><i class='fa fa-times'></i></button> <button  class='btn btn-primary' title='Save' onClick='updategnr(".$glist['programgraduateid'].")'><i class='gi gi-floppy_saved'></i></button></td>";
