            ...
            <div class="block">
                ...
                <form action="#" method="post" class="form-horizontal" onsubmit="return false;">
					...
					<input type="hidden" id="uid" name="state-normal" class="form-control" >
						...
						<label class="col-md-3 control-label" for="state-normal">User Group</label>
                        <div class="col-md-7">
                            <select id="usergroup" name="example-select" class="form-control" size="1" tabindex="0" >
	...
	<div class="block full">
        ...
        <div class="table-responsive">
			...
			*/
				...
				if($users['uid']!=1){
					echo "<button class='btn btn-danger notification' title='Delete User' id='notification' onClick='deleteuser(".$users['uid'].")'><i class='fa fa-times'></i></button>";
				}
				echo "</td>";
				echo "</tr>";
