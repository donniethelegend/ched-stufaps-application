   ...
   <div class="col-lg-12">
            ...
            <div class="block">
                ...
                <form action="#" method="post" class="form-horizontal" onsubmit="return false;">
					...
					<input type="hidden" id="heiuid" name="state-normal" class="form-control" >
                        ...
                        <div class="col-md-8">
						   ...
						   <?php
													...
													echo "<option value='".$heis['instcode']."'>".$heis['instcode']." - $heiname</option>";
                        ...
                        <div class="col-md-7">
                            <input type="text" id="hei_email" name="state-normal" class="form-control" tabindex="0" >
                        </div>
						<label class="col-md-3 control-label" for="state-normal">Contact No.</label>
                        <div class="col-md-7">
                            <input type="text" id="hei_contactno" name="state-normal" class="form-control" tabindex="0" >
                        </div>
						
						<label class="col-md-3 control-label" for="state-normal">User Type</label>
                        <div class="col-md-7">
                            <select id="usertype" name="example-select" class="form-control" size="1" tabindex="0" disabled>
            ...
            <!-- END Input States Block -->
                            ...
                            <div class="modal-footer">
                                <button type="button" id="saveuser" class="btn btn-effect-ripple btn-primary" onclick="saveheiuser();">Save</button>
								<button type="button" id="updateuser" class="btn btn-effect-ripple btn-primary" onclick="updateheiuser();">Update</button>
	...
	<div class="block full">
        ...
        <div class="table-responsive">
            <table id="example-datatable" class="table table-striped table-bordered table-vcenter table-hover">
				...
				echo "<td>".$users['hei_email']."</td>";
				echo "<td>".$users['hei_contactno']."</td>";
				if($users['changed_pwd']=="NO"){
					$cpwd = " <span class='label label-warning'>No</span>";
				}else{
					$cpwd = "<span class='label label-success'>Yes</span>";
				}
				echo "<td>".$cpwd."</td>";
				//echo "<td>".$users['usergroup']."</td>";
			...
			*/
				...
				echo "<button class='btn btn-primary' title='Edit User'  onClick='edituser(".$users['heiuid'].")'  data-toggle='modal' data-target='#addusermodal'><i class='fa fa-edit'></i></button>
					<button class='btn btn-warning' title='Change Password' onClick='changepassword(".$users['heiuid'].")'  data-toggle='modal' data-target='#changepassword'><i class='gi gi-rotation_lock'></i></button>";
				//if($users['heiuid']!=1){
					echo "<button class='btn btn-danger notification' title='Delete User' id='notification' onClick='deleteuser(".$users['heiuid'].")'><i class='fa fa-times'></i></button>";
				//}
				echo "</td>";
				echo "</tr>";
