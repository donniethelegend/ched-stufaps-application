   ...
   <div class="col-lg-12">
	...
	<div class="block full">
        <div class="block-title">
            <a href="#modal-regular" onClick="addcontactbutton();" class="btn btn-effect-ripple btn-primary" data-toggle="modal">Add Contact</a>
        ...
        <div class="table-responsive">
            <table id="example-datatable" class="table table-striped table-bordered table-vcenter table-hover">
				...
				echo "<td><button data-toggle='modal' data-target='#modal-regular' class='btn btn-primary' title='Edit Contact'  onClick='editcontact(".$contact['contactid'].")'><i class='fa fa-edit'></i></button> <button  onclick='deletecontact(".$contact['contactid'].");' type='reset' class='btn btn-effect-ripple btn-danger'><i class='fa fa-times'></i></button></td></tr>";
				...
				<div class="modal-dialog">
					<div class="modal-content">
								...
								<input type="hidden" id="contactid">
                                    ...
                                    <form action="page_forms_components.html" method="post" class="form-horizontal" onsubmit="return false;">
										...
										<div class="form-group">
                                            ...
                                            <div class="col-md-6">
												<textarea class="form-control" id="telno"></textarea>
						...
						<div class="modal-footer">
							<button type="button" id="savebutton" class="btn btn-effect-ripple btn-primary" onclick="savesinglecontact();">Save</button>
							<button type="button" id="updatebutton" class="btn btn-effect-ripple btn-primary" onclick="updatecontact();">Update</button>
