	...
	<div class="block full">
        ...
        <div class="table-responsive">
            <table id="example-datatable" class="table table-striped table-bordered table-vcenter table-hover">
				...
				echo "<td><button data-toggle='modal' data-target='#modal-regular' class='btn btn-primary' title='Edit Contact'  onClick='editeteeap(".$eteeap['eteeapid'].")'><i class='fa fa-edit'></i></button><button  onclick='deleteeteeap(".$eteeap['eteeapid'].");' type='reset' class='btn btn-effect-ripple btn-danger'><i class='fa fa-times'></i></button></td></tr>";
