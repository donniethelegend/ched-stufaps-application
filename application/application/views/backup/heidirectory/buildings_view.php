	...
	<div class="block full">
        <div class="block-title">
            <a href="#modal-regular" class="btn btn-effect-ripple btn-primary" data-toggle="modal" onclick="addrecord();">Add Record</a>
			  <a href="<?=base_url()?>buildings/buildingsxls" class="btn btn-effect-ripple btn-success" data-toggle="modal" target="_blank"><i class="hi hi-download-alt"></i> Download XLS</a>
        ...
        <div class="table-responsive">
            <table id="example-datatable" class="table table-striped table-bordered table-vcenter table-hover">
				...
				echo "<td><a href='heidirectory/institution/".$buildings['instcode']."'>".$buildings['instname']."</a></td>";
				...
				echo "<td><button data-toggle='modal' data-target='#modal-regular' class='btn btn-primary hidden' title='Edit Contact'  onClick='editeteeap(".$buildings['buildingid'].")'><i class='fa fa-edit'></i></button><button  onclick='deletebuilding(".$buildings['buildingid'].");' type='reset' class='btn btn-effect-ripple btn-danger'><i class='fa fa-times'></i></button></td></tr>";
