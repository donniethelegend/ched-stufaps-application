   ...
   <div class="col-lg-12">
	...
	<div class="block full">
        <div class="block-title">
            <h2>List</h2>
			<a href="<?=base_url()?>functions/heidirectoryxls" class="btn btn-effect-ripple btn-success" data-toggle="modal" target="_blank"><i class="hi hi-download-alt"></i> Download XLS</a>
