...
<head>
	...
	<title>CHED-Home</title>
    <link rel="shortcut icon" href="<?=base_url()?>public/assets/img/logo_ched.png">
	...
	<!-- Theme JS files -->
	<script src="<?=base_url()?>public/global_assets/js/plugins/visualization/echarts/echarts.min.js"></script>

	<script src="<?=base_url()?>public/assets/js/app.js"></script>
	<script src="<?=base_url()?>public/global_assets/js/demo_pages/charts/echarts/pies_donuts.js"></script>
    
   
    <script src="<?=base_url()?>public/global_assets/js/demo_pages/charts/echarts/columns_waterfalls.js"></script>
	<!-- /theme JS files -->
