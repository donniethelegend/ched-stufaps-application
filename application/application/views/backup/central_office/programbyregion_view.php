                                ...
                                <div class="block full">
                                    ...
                                    <div class="block-title">
                                        ...
                                        <ul class="nav nav-tabs" data-toggle="tabs">
                                            <li class="active"><a href="#block-tabs-home">Program by Region</a></li>
						...
						<div class="col-lg-12">
                                <div class="widget">
                                    <div class="widget-content widget-content-mini themed-background-dark-default text-light text-center">
                                        <i class="fa fa-bar-chart-o"></i> <strong>Program by Region</strong>
                                    </div>
	...
	<div class="block full">
        ...
        <div class="table-responsive">
            <table id="example-datatable" class="table table-striped table-bordered table-vcenter table-hover">
				...
				foreach ($totalprogramperregion_table as $totalprogram):
				//$heiname = strtoupper($prog['mainprogram']);
				echo "<tr>";
				echo "<td>".$totalprogram['value']."</td>";
				echo "<td>".$totalprogram['regionname']."</td>";
				
				
				
				//echo "<td></td> ";
				//echo "<td><a href='heibyregion/instprofile/".$totalprogram['region_db']."/ACTIVE' type='button' class='btn btn-effect-ripple btn-success' title='Download HEI'><i class='fa fa-download'></i></a></td> ";
				echo "<td><a href='programbyregion/programprofile/".$totalprogram['region_db']."' type='button' class='btn btn-effect-ripple btn-success' title='Download Program Profile'><i class='fa fa-download'></i></a></td> ";
...
echo "<input type='hidden' id='region_values' value='".$totalprogramperregion."'>";
