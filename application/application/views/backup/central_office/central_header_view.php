...
<!--[if gt IE 9]><!--> <html class="no-js" lang="en"> <!--<![endif]-->
    <head>
        ...
        <title><?php echo $this->session->userdata('office_name'); ?></title>

        <meta name="description" content="CHECKS & KMS is developed by Elvin Casem and Christianne Lynnette Cabanban. This system is initiated by CHED Regional Office 1 and called CHED S.O.S. (Synchronized Operational System)">
        <meta name="author" content="Elvin Casem, Christianne Lynnette Cabanban">
