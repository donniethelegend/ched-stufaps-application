                            ...
                            <div class="col-sm-6 col-lg-6">
                                <a href="#" class="widget">
                                    <div class="widget-content widget-content-mini text-right clearfix">
										...
										2019, Type C & Year Level 1-4, Grade Above 90
									
										<br> 2019, Type A,B & Year Level 2-4, Grade Above 90
											<br> 2019, Type A,B,C,D & Year Level 1-5, Grade Below 90
										</strong>
                                        </h2>
...
<div class="block full">
        <div class="block-title">
			 ...
			 <a href="<?=base_url()?>functions/downloadctdp_part1/<?php echo $current_year_filter;?>" class="btn btn-effect-ripple btn-success" data-toggle="modal" target="_blank"><i class="hi hi-download-alt"></i> Download ALL Applicant CHED TDP Part 1</a>
			 <a href="<?=base_url()?>functions/downloadctdp_part2/<?php echo $current_year_filter;?>" class="btn btn-effect-ripple btn-success" data-toggle="modal" target="_blank"><i class="hi hi-download-alt"></i> Download ALL Applicant CHED TDP Part 2</a>
			 <a href="<?=base_url()?>functions/downloadctdp_part3/<?php echo $current_year_filter;?>" class="btn btn-effect-ripple btn-success" data-toggle="modal" target="_blank"><i class="hi hi-download-alt"></i> Download ALL Applicant CHED TDP Part 3</a>
			
			
			
        </div>
         <div class="table-responsive">
            <table  class="table table-striped hover datatablectdp-ajax"  id="DataTables_Table_1">
                <thead>
                    <tr>
                        <th >ID</th>
                        <th>Students Name</th>
						...
						<th>Province</th>
						<th>Average Grade</th>
						<th>Equivalent Grade 40%</th>
						<th>Income</th>
						<th>Equivalent Income 60%</th>
						<th>Total Points</th>
						<th>Year Level</th>
						<th>Type</th>
						<th>Year Applied</th>
