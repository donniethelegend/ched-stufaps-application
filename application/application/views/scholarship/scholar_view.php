...
<div id="page-container" class="header-fixed-top sidebar-visible-lg-full">
                                ...
                                <div class="widget">
                                    ...
                                    <div class="widget-content widget-content-full border-bottom">
									  ...
									  <h4>Scholarship</h4>
										...
										<p>
										Scholar Type: <select id="towncity_select" name="example-select2" class="form-control" style="width: 100%;" data-placeholder="Choose one..">
												
                                                <?php
													$type_s = 0;
													foreach($scholarship_type as $stype):
														if($scholar_profile['stypecode']==$stype['stypecode']){
															$typeco = "selected='selected'";
															$type_s++;
														}else{
															$typeco = "";
															
														}
														echo "<option value=".$stype['stypecode']." $typeco>".$stype['stypedescription']."</option>";
													endforeach;
													
													if($type_s==0){
														echo "<option value=".$stype['stypecode']." $typeco>".$stype['typecode']."</option>";
													}
										...
										<br>
										Award Number: <strong><input type="text" id="awardnumber" class="form-control" placeholder="" value="<?php echo $scholar_profile['awardnumber'];?>"></strong>
										<br>
										Award Status: <select id="towncity_select" name="example-select2" class="form-control" style="width: 100%;" data-placeholder="Choose one..">
												<option <?php echo $scholar_profile['award_status'];?> selected="selected"><?php echo $scholar_profile['award_status'];?></option>
                                ...
                                <div class="block full">
                                    ...
                                    <div class="block-title">
                                        ...
                                        <ul class="nav nav-tabs" data-toggle="tabs">
											...
											<li class="hidden"><a href="#profile-followers">Family Background</a></li>
 ...
 <table id="voucherlist-table" class="table table-striped table-bordered table-vcenter table-condensed table-hover awardnumbertable">
                                    <thead>
                                        <tr>
				...
				foreach ($scholar_voucher as $voucher):
					echo "<tr>";
						...
						echo "<td class='text-center'>
							<a onclick='editvoucher(".$voucher['voucherid'].");' href='#modal-voucher' data-toggle='modal' title='Edit Payment' class='btn btn-effect-ripple btn-sm btn-success'><i class='fa fa-pencil' ></i></a>
							<a href='#' onclick='deletevoucher(".$voucher['voucherid'].")' data-toggle='tooltip' title='Cancel Payment' class='btn btn-effect-ripple btn-sm btn-danger' ><i class='fa fa-times'></i></a>
						</td>";
					echo "</tr>";
 ...
 <table id="general-table" class="table table-striped table-bordered table-vcenter table-condensed table-hover">
				...
				foreach ($scholar_payment as $payment):
					echo "<tr>";
						...
						if($payment['status']=="Staled"){
							echo "<td><a href='#' class='label label-warning'>".$payment['status']."</a>";
								
						}
						if($payment['status']=="Pending"){
							echo "<td><a href='#' class='label label-default'>".$payment['status']."</a>";
								
						}
						echo "<td>".$payment['releasedate']."</td>";
						...
						echo "<td class='text-center'>
							...
							<a href='javascript:deletepayment(".$payment['spaymentid'].")' data-toggle='tooltip' title='Delete Payment' class='btn btn-effect-ripple btn-sm btn-danger' ><i class='fa fa-times'></i></a>
						</td>";
					echo "</tr>";
				...
				?>
							...
							<div class="col-md-6">
								<input type="text" id="lastname" class="form-control" placeholder="Lastname" value="<?php echo $scholar_profile['lastname'];?>" >
								<input type="text" id="firstname" class="form-control" placeholder="Firstname" value="<?php echo$scholar_profile['firstname'];?>" >
								<input type="text" id="middlename" class="form-control" placeholder="Middlename" value="<?php echo$scholar_profile['middlename'];?>" >
								<input type="text" id="extension" class="form-control" placeholder="Extension" value="<?php echo $scholar_profile['extension'];?>" >
							</div>
                                        </div>
								<div class="row"></div>		
						<div class="form-group">
							...
							<div class="col-md-8">
								<input type="text" id="dateofbirth"  class="form-control input-datepicker" data-date-format="yyyy-mm-dd" placeholder="yyyy-mm-dd" value="<?php echo $scholar_profile['dateofbirth'];?>" >
						...
						<div class="form-group">
							...
							<div class="col-md-8">
								<input type="text" id="placeofbirth" class="form-control" placeholder="" value="<?php echo $scholar_profile['placeofbirth'];?>" >
						...
						<div class="form-group">
							...
							<?php
								if($scholar_profile['gender']=="Female"){
						...
						<div class="form-group">
							...
							<?php
								if($scholar_profile['civilstatus']=="Single"){
									$civils = "checked='checked'";
									$civilm = "";
								}
								if($scholar_profile['civilstatus']=="Married"){
									$civils = "";
						...
						<div class="form-group">
							...
							<div class="col-md-8">
								<input type="text" id="citizenship" class="form-control" placeholder="" value="<?php echo $scholar_profile['citizenship'];?>" >
						...
						<div class="form-group">
							...
							<div class="col-md-8">
								<input type="text" id="contactno" class="form-control" placeholder="" value="<?php echo $scholar_profile['contactno'];?>" >
						...
						<div class="form-group">
							...
							<div class="col-md-8">
								<input type="text" id="email" class="form-control" placeholder="" value="<?php echo $scholar_profile['email'];?>" >
						...
						<div class="form-group">
							...
							<div class="col-md-8">
								<input type="text" id="barangay" class="form-control" placeholder="" value="<?php echo$scholar_profile['barangay'];?>" >
						...
						<div class="form-group">
							...
							<div class="col-md-8">
								<input type="text" id="towncity" class="form-control" placeholder="" value="<?php echo $scholar_profile['towncity'];?>" >
						...
						<div class="form-group">
							...
							<div class="col-md-8">
								<input type="text" id="province" class="form-control" placeholder="" value="<?php echo $scholar_profile['province'];?>" >
						...
						<div class="form-group">
							...
							<div class="col-md-8">
								...
								<select id="congressionaldistrict" class="form-control">
									<option value="<?php echo $scholar_profile['congressionaldistrict'];?>"><?php echo $scholar_profile['congressionaldistrict'];?></option>
									<option value="ILOCOS NORTE 1">ILOCOS NORTE D1</option>
									<option value="ILOCOS NORTE 2">ILOCOS NORTE D2</option>
									<option value="ILOCOS SUR 1">ILOCOS SUR D1</option>
									<option value="ILOCOS SUR 2">ILOCOS SUR D2</option>
									<option value="LA UNION 1">LA UNION D1</option>
									<option value="LA UNION 2">LA UNION D2</option>
									<option value="PANGASINAN 1">PANGASINAN D1</option>
									<option value="PANGASINAN 2">PANGASINAN D2</option>
									<option value="PANGASINAN 3">PANGASINAN D3</option>
									<option value="PANGASINAN 4">PANGASINAN D4</option>
									<option value="PANGASINAN 5">PANGASINAN D5</option>
									<option value="PANGASINAN 6">PANGASINAN D6</option>
									<option value="PANGASINAN CD4">PANGASINAN CD4</option>
									<option value="LONE">LONE</option>
									<option value="PANGASINAN D6 CO D3">PANGASINAN D6 CO D3</option>
						...
						<div class="form-group">
							...
							<div class="col-md-8">
								<input type="text" id="zipcode" class="form-control" placeholder="" value="<?php echo $scholar_profile['zipcode'];?>" >
						...
						<div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                <select id="heicode" name="example-select2" class="select-select2" data-placeholder="Choose one.." >
                                                    <!-- Required for data-placeholder attribute to work with Select2 plugin -->
						
						<?php
						foreach ($hei_list as $heis):
						$heiname = strtoupper($heis['heiname']);
							if($scholar_profile['hei']==$heis['heicode']){
								$selectedhei = "selected='selected'";
							}else{
								$selectedhei = "";
								echo "<option ".$scholar_profile['hei'].">".$scholar_profile['hei']."</option>";
							}
						echo "<option value='".$heiname."' $selectedhei>$heiname</option>";
						...
						?>
							...
							<div class="col-md-8">
								<input type="text" id="course" class="form-control" placeholder="" value="<?php echo $scholar_profile['course'];?>" >
							...
							<div class="col-md-4">
								...
								<select id="year_level" class="form-control">
									...
									<option value="<?php echo $scholar_profile['year_level'];?>"><?php echo $scholar_profile['year_level'];?></option>
							...
							<div class="col-md-4">
								<input type="text" id="yearofapplication" class="form-control" placeholder="" value="<?php echo $scholar_profile['yearapplied'];?>" >
								
							</div>
							<div class="row"></div>
							<label class="col-md-3 control-label" for="state-normal">High School Graduated</label>
							<div class="col-md-4">
								<input type="text" id="hsgraduated" class="form-control" placeholder="" value="<?php echo $scholar_profile['hsgraduated'];?>" >
				...
				<div class="form-group">
							<label class="col-md-3 control-label" for="state-normal">Type</label>
								...
								<div class="col-md-8">
								<select id="grantee_status" class="form-control">
								<option value="<?php echo $scholar_profile['grantee_status'];?>"><?php echo $scholar_profile['grantee_status'];?></option>
								<option value="C - Active">C - Active
</option>
								<option value="G - Graduated">G - Graduated
</option>
								<option value="WV - Waived">WV - Waived
</option>
								<option value="Terminated">Terminated
</option>
								<option value="Unawarded">Unawarded
</option>
				...
				<div class="form-group">
							<label class="col-md-3 control-label" for="state-normal">Remarks</label>
								...
								<div class="col-md-8">
								<input type="text" id="grantee_remarks" class="form-control" placeholder="" value="<?php echo $scholar_profile['grantee_remarks'];?>" >
							...
							<div class="col-md-8">
								<button type="button" class="btn btn-primary" onclick="savegranteeinfo(<?php echo $scholarid;?>)">Save</button>
			...
			<div class="form-group">
							...
							<div class="col-md-8">
								<input type="text" id="father" class="form-control" placeholder="" value="<?php echo $scholar_profile['father'];?>" >
								
							</div>
							<label class="col-md-3 control-label" for="state-normal">Occupation</label>
							<div class="col-md-8">
								<input type="text" id="foccupation" class="form-control" placeholder="" value="<?php echo $scholar_profile['foccupation'];?>" >
								
							</div>
							<label class="col-md-3 control-label" for="state-normal">Mother's Name</label>
							<div class="col-md-8">
								<input type="text" id="mother" class="form-control" placeholder="" value="<?php echo $scholar_profile['mother'];?>" >
								
							</div>
							<label class="col-md-3 control-label" for="state-normal">Occupation</label>
							<div class="col-md-8">
								<input type="text" id="moccupation" class="form-control" placeholder="" value="<?php echo $scholar_profile['moccupation'];?>">
								
							</div>
							
							<label class="col-md-3 control-label" for="state-normal">Number of Siblings</label>
							<div class="col-md-3">
								<input type="text" id="siblingno" class="form-control" placeholder="" value="<?php echo $scholar_profile['siblingno'];?>" >
								
							</div>
							<div class="row"></div>
							<label class="col-md-3 control-label" for="state-normal">Disability</label>
							<div class="col-md-8">
								<input type="text" id="disability" class="form-control" placeholder="" value="<?php echo $scholar_profile['disability'];?>">
							...
							<div>
                                ...
                                <div class="block">
									...
									<input type="hidden" id="spaymentid">
										...
										<div class="form-group">
                                            <label class="col-md-3 control-label" for="state-normal">Check Date</label>
                                            <div class="col-md-6">
			...
			<div id="modal-voucher" class="modal" role="dialog" aria-hidden="true">
				<div class="modal-dialog">
					<div class="modal-content">
						<div class="modal-header">
							<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
							<h3 class="modal-title"><strong>Voucher Details</strong></h3>
						</div>
						<div class="modal-body">
...
<!-- Block Tabs -->
                                    ...
                                    <div class="block-title">
                                        ...
                                        <ul class="nav nav-tabs" data-toggle="tabs">
                                            ...
                                            <li class="hidden"><a href="#block-tabs-profile" onclick="populateentry(<?php echo $scholar_profile['scholarid'];?>);">Accounting Entry</a></li>
...
<div class="tab-content">
	...
	<div class="col-md-6">
		<input type="text" name="state-normal" class="form-control" id="responsibility" >
	</div>
	</div>
	...
	<div class="col-md-6">
		<input type="text" name="state-normal" class="form-control" id="mfopap">
	</div>
	</div>
...
<tbody>
						...
						<div class="modal-footer">
							<button id="savevoucherbutton" type="button" class="hidden btn btn-effect-ripple btn-primary" onclick="savevoucher(<?php echo $scholar_profile['scholarid'];?>);" >Save</button>
