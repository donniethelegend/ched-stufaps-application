...
<!--  Row -->
	...
	<div class="row">
			...
			<div class="col-md-12">
				<select onchange="updatestudentlist(this.value);" id="example-select2" class="select-select2" style="width: 100%;" data-placeholder="Congressional District">
					<option></option><!-- Required for data-placeholder attribute to work with Select2 plugin -->
					
					<?php
						foreach ($cong_district as $cdistrict):
					...
					?>                   
							...
							?>
									...
									<div class="row">
									<div class="form-group">
                                            <center><label class="col-md-12 control-label" for="example-select">Payment Type</label></center>
                                            <div class="col-md-12">
						...
						echo "<tr>";
						echo "<td>".$vlist['batch']."</td>";
						echo "<td>".$vlist['batch']."</td>";
						echo "<td>".$vlist['batch']."</td>";
						echo "<td>".$vlist['batch']."</td>";
						echo "<td>".$vlist['batch']."</td>";
						echo "<td class='text-center'><a class='btn btn-effect-ripple btn-sm btn-primary' href='batchvoucher/printvoucher/' target='_blank'><i class='fa fa-print'></i></a><a href='#' data-toggle='tooltip' title='Cancel Voucher' class='btn btn-effect-ripple btn-sm btn-danger' ><i class='fa fa-times'></i></a> </td>";
						echo "</tr>";
