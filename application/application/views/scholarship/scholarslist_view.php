...
<div class="row">
   <div class="col-lg-12">
	...
	<form method="post" action="scholarslist">
	...
	<form method="post" action="scholarslist">
			...
			<select class="form-control" id="statusfilter" name="statusfilter">
				<option value="<?php echo $post_statusfilter;?>" selected="selected"><?php echo $post_statusfilter;?></option>
				<?php
					foreach($grantee_status as $gstatus):
						echo "<option value='".$gstatus['grantee_status']."'>".$gstatus['grantee_status']."</option>";
					endforeach;
				?>
		...
		<div class="col-md-1">Congressional District: </div>
		<div class="col-lg-2">
		
			
			<select class="form-control" id="cong_district" name="cong_district">
				<option value="<?php echo $post_cong_district;?>" selected="selected"><?php echo $post_cong_district;?></option>
				<?php
					foreach($congressional_district as $cdistrict):
						echo "<option value='".$cdistrict['congressionaldistrict']."'>".$cdistrict['congressionaldistrict']."</option>";
					endforeach;
				?>
				<option value="All">All</option>
        ...
        <div class="table-responsive">
            <table id="example-datatable" class="table table-striped table-bordered table-vcenter table-hover">
				...
				//echo "<td>".$scholar['grantee_status']."</td>";
						if($scholar['grantee_status']=="C - Active"){
							echo "<a href='#' class='label label-success'>".$scholar['grantee_status']."</a>";
								
						}
						if($scholar['grantee_status']=="Terminated"){
							echo "<a href='#' class='label label-danger'>".$scholar['grantee_status']."</a>";
								
						}
						if($scholar['grantee_status']=="Inactive"){
							echo "<a href='#' class='label label-warning'>".$scholar['grantee_status']."</a>";
								
						}
						if($scholar['grantee_status']=="WV - Waived"){
							echo "<a href='#' class='label label-warning'>".$scholar['grantee_status']."</a>";
								
						}
						if($scholar['grantee_status']=="G - Graduated"){
							echo "<a href='#' class='label label-default'>".$scholar['grantee_status']."</a>";
								
						}
						if($scholar['grantee_status']=="New"){
							echo "<a href='#' class='label label-info'>".$scholar['grantee_status']."</a>";
						}
				echo "</td>";
				echo "<td>".$scholar['course']."</td>";
				echo "<td><button onclick='deletegrantee(".$scholar['scholarid'].");' type='reset' class='btn btn-xs btn-effect-ripple btn-danger'><i class='fa fa-times'></i></button></td></tr>";
            ...
            <!-- END Input States Block -->
							...
							<button type="button" id="addbutton" class="btn btn-effect-ripple btn-primary" onclick="deletegranteenow();">Delete</button>
