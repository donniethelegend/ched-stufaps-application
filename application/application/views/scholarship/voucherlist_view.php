	...
	<div class="block full">
        ...
        <div class="table-responsive">
            <table id="example-datatable" class="table table-striped table-bordered table-vcenter table-hover">
				...
				echo "<td><a href='javascript:deletevoucher(".$voucher['voucherid'].",".$voucher['scholarid'].")' data-toggle='tooltip' title='Delete Voucher' class='hidden btn btn-effect-ripple btn-sm btn-danger' ><i class='fa fa-times'></i></a></tr>";
