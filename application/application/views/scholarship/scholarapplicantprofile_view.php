...
<div id="page-container" class="header-fixed-top sidebar-visible-lg-full">
	...
	<div id="main-container">
		...
		<div class="row">
			...
			if($status=="yes"){
				echo "<img style='width:35%;' src='$fileurl' alt='avatar' class='img-circle img-thumbnail img-thumbnail-transparent img-thumbnail-avatar-3x push'>";
			}else{
				echo "<img style='width:35%;' src='".base_url()."public/img/placeholders/avatars/avatar13@2x.jpg' alt='avatar' class='img-circle img-thumbnail img-thumbnail-transparent img-thumbnail-avatar-3x push'>";
			}
		 ?>
         ...
         <input type = "submit" value = "upload"  class="btn btn-effect-ripple btn-primary"/> 
                                    ...
                                    <div class="widget-content border-bottom">
										...
										Address: <strong><?php echo $scholarapplicant_profile['barangay'];?>
										 ...
										 <br>
										 Place of Birth: <strong><?php echo $scholarapplicant_profile['placeofbirth'];?></strong>
										 <br>
										 Civil Status: <strong><?php echo $scholarapplicant_profile['civilstatus'];?></strong>
										 <br>
										...
										Date Time Encoded: <strong><?php echo $scholarapplicant_profile['time_encoded'];?></strong>
										
										<br>
									
										
										Encoded by: <strong><?php echo $scholarapplicant_profile['name'];?></strong>
                                ...
                                <div class="block full">
                                    ...
                                    <div class="block-title">
                                        ...
                                        <ul class="nav nav-tabs" data-toggle="tabs">
											<li class="hidden"><a href="#voucher">Voucher</a></li>
                                            <li class="hidden"><a href="#profile-activity">Payments</a></li>
				...
				*/
				?>
						...
						$heiname = strtoupper($heis['heiname']);
							if($scholarapplicant_profile['hei']==$heis['heicode']){
								$selectedhei = "selected='selected'";
							}else{
								$selectedhei = "";
							}
							
							echo "<option value='".$heis['heicode']."' $selectedhei>$heiname</option>";

						endforeach;
						if($scholarapplicant_profile['hei']==""){
				...
				<div class="form-group">
							...
							<div class="col-md-4">
								...
								<option value="<?php echo $scholarapplicant_profile['dswd4p'];?>"><?php echo $scholarapplicant_profile['dswd4p'];?></option>
				...
				<div class="form-group">
							...
							<div class="col-md-4">
							<input type="text" id="datereceived"  class="form-control input-datepicker" data-date-format="yyyy-mm-dd" placeholder="yyyy-mm-dd" value="<?php echo $scholarapplicant_profile['datereceived'];?>">
			...
			<div class="form-group">
							...
							<div class="col-md-8">
								<select id="fstatus" class="form-control">
											<option value="<?php echo $scholarapplicant_profile['fstatus'];?>"><?php echo $scholarapplicant_profile['fstatus'];?></option>
							...
							<div class="col-md-8">
								...
								<input type="text" id="father_m" class="form-control" placeholder="" value="<?php echo $scholarapplicant_profile['father_m'];?>" >
								<input type="text" id="father_l" class="form-control" placeholder="" value="<?php echo $scholarapplicant_profile['father_l'];?>" >
							...
							<div class="col-md-8">
								<select id="mstatus" class="form-control">
											<option value="<?php echo $scholarapplicant_profile['mstatus'];?>"><?php echo $scholarapplicant_profile['mstatus'];?></option>
											<option value="Living">Living</option>
											<option value="Deceased">Deceased</option>
								</select>
							...
							<div class="col-md-8">
								...
								<input type="text" id="mother_m" class="form-control" placeholder="" value="<?php echo $scholarapplicant_profile['mother_m'];?>" >
								<input type="text" id="mother_l" class="form-control" placeholder="" value="<?php echo $scholarapplicant_profile['mother_l'];?>" >
							...
							<div class="col-md-8">
								<input type="text" id="lrn_no" class="form-control" placeholder="" value="<?php echo $scholarapplicant_profile['lrn_no'];?>" >
	...
	<div class="tab-pane" id="gradeincome">
		<div class="block-full">
			...
			<div class="form-group">
							...
							<label class="col-md-3 control-label" for="state-normal">Total Grade (60%)</label>
							<div class="col-md-8">
								<input type="text" id="totalgrade" class="form-control" placeholder="" value="<?php echo $scholarapplicant_profile['totalgrade'];?>" disabled>
								
							</div>
							
							<label class="col-md-3 control-label" for="state-normal">Total Income (40%)</label>
							<div class="col-md-8">
							...
							<label class="col-md-3 control-label" for="state-normal">CSP Equivalent Grade</label>
							<div class="col-md-8">
								<input type="text" id="equivgrade" class="form-control" placeholder="" value="<?php echo $scholarapplicant_profile['cspequivgradeabove'];?>" disabled>
								
							</div>
							
							<label class="col-md-3 control-label" for="state-normal">CSP Equivalent Income</label>
							<div class="col-md-8">
								<input type="text" id="equivincome" class="form-control" placeholder="" value="<?php echo $scholarapplicant_profile['cspequivincome'];?>" disabled>
								
							</div>
							
							<label class="col-md-3 control-label" for="state-normal">Total Grade (70%)</label>
							<div class="col-md-8">
								<input type="text" id="totalgrade" class="form-control" placeholder="" value="<?php echo $scholarapplicant_profile['csptotalgrade'];?>" disabled>
								
							</div>
							
							<label class="col-md-3 control-label" for="state-normal">Total Income (30%)</label>
							<div class="col-md-8">
								<input type="text" id="totalincome" class="form-control" placeholder="" value="<?php echo $scholarapplicant_profile['csptotalincome'];?>" disabled>
								
							</div>
							
							<label class="col-md-3 control-label" for="state-normal">CSP Grand Total</label>
							<div class="col-md-8">
								<input type="text" id="grandtotal" class="form-control" placeholder="" value="<?php echo $scholarapplicant_profile['cspgrandtotal'];?>" disabled>
								
							</div>
							
							<label class="col-md-3 control-label" for="state-normal">Solo Parent Points</label>
							<div class="col-md-8">
								<input type="text" id="grandtotal" class="form-control" placeholder="" value="<?php echo $scholarapplicant_profile['pluspoint'];?>" disabled>
								
							</div>
							
							<label class="col-md-3 control-label" for="state-normal">CSP Grand Total + Points</label>
							<div class="col-md-8">
								<input type="text" id="grandtotal" class="form-control" placeholder="" value="<?php echo $scholarapplicant_profile['totalwithplus'];?>" disabled>
