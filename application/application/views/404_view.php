...
<!--[if gt IE 9]><!--> <html class="no-js" lang="en"> <!--<![endif]-->
    <head>
        ...
        <title>CHED SOS</title>

        
        <meta name="author" content="CHED RO1">
    ...
    <body>
        ...
        <img src="<?=base_url()?>public/img/placeholders/layout/error_full_bg.jpg" alt="Full Background" class="full-bg full-bg-bottom animation-pulseSlow">
        <!-- END Full Background -->
