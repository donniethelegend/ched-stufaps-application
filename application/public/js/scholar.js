function savegranteeinfo(id){
	...
	var grantee_remarks = document.getElementById("grantee_remarks").value;
	...
	$.ajax({
		url: "../updateprofile",
		type: 'post',
		data: {scholarid:id,lastname:lastname,firstname:firstname,middlename:middlename,extension:extension,dateofbirth:dateofbirth,placeofbirth:placeofbirth,gender:gender,civilstatus:civilstatus,citizenship:citizenship,contactno:contactno,email:email,barangay:barangay,towncity:towncity,province:province,congressionaldistrict:congressionaldistrict,zipcode:zipcode,heicode:heicode,course:course,father:father,foccupation:foccupation,mother:mother,moccupation:moccupation,siblingno:siblingno,disability:disability,yearofapplication:yearofapplication,year_level:year_level,grantee_status:grantee_status,grantee_remarks:grantee_remarks,hsgraduated:hsgraduated},
