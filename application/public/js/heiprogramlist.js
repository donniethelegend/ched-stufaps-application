...
function updateprogram(programid){
	...
	$.ajax({
		url: "../updateprogram",
		data: {programid:programid,pstatuscode:pstatuscode, thesisdisert:thesisdisert,pstatyear:pstatyear,pmcode:pmcode,remarks:remarks,nlyears:nlyears,pcredit:pcredit,tuitionperunit:tuitionperunit,programfee:programfee,programlevel:programlevel,instcode:instcode},
		type: 'post',
		success: function(response) {
			console.log(response);
			//window.location.reload();
