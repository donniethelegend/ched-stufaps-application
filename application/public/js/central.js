...
function enablesy(id,ayear){

	var r = confirm("Are your sure you want to enable this School Year?");
    if (r == true) {
        
		$.ajax({
                    url: 'academicyear/enablesy',
                    type: 'post',
                    data: {syid: id,ayear:ayear},
                    success: function(response) {
						console.log(response);
						 $.bootstrapGrowl('<h4><strong>Success</strong></h4> <p>School Year Updated.</p>', {
							type: 'success',
							delay: 3000,
							allow_dismiss: true,
							offset: {from: 'top', amount: 20}
...
function disablesy(id){
	
	var r = confirm("Are your sure you want to disable this School Year?");
    if (r == true) {
        
		$.ajax({
                    url: 'academicyear/disablesy',
                    type: 'post',
                    data: {syid: id},
                    success: function(response) {
						console.log(response);
