...
function saveheiinformation(instcode){
	...
	var highesteduchead = document.getElementById("highesteduchead").value;
	...
	//alert(longtitude);
	$.ajax({
		url: "../saveheiinfo/"+instcode,
		type: 'post',
		data: {instcode:instcode, heitype:heitype,province2:province2,insthead:insthead,titlehead:titlehead,atel:atel,afax:afax,ainsttelhead:ainsttelhead,aemail:aemail,awebsite:awebsite,instname:instname,form_ownership:form_ownership,astreet:astreet,amunicipality:amunicipality,aprovince:aprovince,aregion:aregion,azip:azip,aestablished:aestablished,asec:asec,ayearapproved:ayearapproved,acollege:acollege,auniversity:auniversity,insttype:insttype,insttype2:insttype2,hei_remarks:hei_remarks,hei_status:hei_status,latitude:latitude,longtitude:longtitude,highesteduchead:highesteduchead,heid:heid},
		success: function(response) {
			console.log(response);
			window.location.reload();;
		}
...
function editinstitution(){
	...
	$('#insttype').prop("disabled", false);
	$('#insttype2').prop("disabled", false);
	$('#hei_remarks').prop("disabled", false);
	$('#hei_status').prop("disabled", false);
	$('#latitude').prop("disabled", false);
	$('#longtitude').prop("disabled", false);
