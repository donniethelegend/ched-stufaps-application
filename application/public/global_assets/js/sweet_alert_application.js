...
var SweetAlert = function () {
    ...
    var _componentSweetAlert = function() {
        ...
        // Close button success button
        $('#sweet_close').on('click', function() {
			var applicationid = document.getElementById("applicationid").value;
			
			var mprefix = document.getElementById("mobile_prefix").value;
			var mobileno = document.getElementById("mobile_number").value;
			var mno = mprefix+mobileno;
			
            swal({
                title: 'Application Submitted!',
                html: '<form action="print_application" method="post" id="printpdf">Your Application #:<strong>'+applicationid+ '</strong><br>Save this # for your reference.<br><a onclick="tmp_print();"> <button type="button" class="btn btn-primary" ><i class="icon-file-download"></i> Download Application </button><input type="hidden" name="applicationno" value="'+applicationid+'"><input type="hidden" name="mno" value="'+mno+'"></form></a>',
                type: 'success',
		...
		$('#sweet_reprint').on('click', function() {
			//var applicationid = document.getElementById("rapplicationid").value;
			//var mno = document.getElementById("rmobile_number").value;
			
            swal({
                title: 'Re-Print Application Form',
                html: '<form action="print_application" method="post" id="printpdf">Your Application #:<input type="text" class="form-control" placeholder="Application Number" id="applicationno" name="applicationno"><br>Mobile Number:<input type="text" class="form-control" placeholder="639876543210" id="mno" name="mno"><br><a onclick="tmp_print();"> <button type="button" class="btn btn-primary" ><i class="icon-file-download"></i> Download Application </button></form></a>',
               // type: 'success',
                //showCloseButton: true,
				allowOutsideClick: false,
		...
		$('#sweet_myportal').on('click', function() {
			//var applicationid = document.getElementById("rapplicationid").value;
			//var mno = document.getElementById("rmobile_number").value;
			
            swal({
                title: 'Login to view Portal',
                html: '<form action="./index.php/myportal/login" method="post" >Your Application #:<input type="text" class="form-control" placeholder="Application Number" id="applicationno" name="applicationno"><br>Mobile Number:<input type="text" class="form-control" placeholder="639876543210" id="mno" name="mno"><br> <button type="submmit" class="btn btn-primary" >Login</button></form>',
               // type: 'success',
                //showCloseButton: true,
				allowOutsideClick: false,
		...
		$('#notice_html').on('click', function() {
			//var applicationid = document.getElementById("rapplicationid").value;
			//var mno = document.getElementById("rmobile_number").value;
			
            swal({
                title: '<span style="color:red;font-weight:bold;">PLEASE READ!</span>',
				type: 'info',
                html: 'After accomplishing this online form, please wait for our follow-up text/e-mail before you submit your <span style="color:red;font-weight:bold;">Printed APPLICATION FORM and Complete Requirements</span>. <strong>NO NEED TO COME TO OUR OFFICE UNTIL FURTHER NOTICE.</strong>',
               // type: 'success',
                showCloseButton: true,
        ...
        $('#sweet_error').on('click', function() {
            swal({
                title: 'Oops...',
                text: 'Something went wrong!, Please check the reCAPTCHA field.',
                type: 'error',
				allowOutsideClick: false
            });
        });
		...
		// Error alert
        $('#sweet_error_duplicate').on('click', function() {
            swal({
                title: 'Oops...',
                html: 'Sorry, we cannot save your record. <br> We have seen that your application has a duplicate entry on our database. For further assistance, contact CHED Regional Office 1. Thank you.',
                type: 'info',
				allowOutsideClick: false
            });
        });
        ...
        $('#sweet_html').on('click', function() {
            swal({
                title: '<h2>Saving your application details...</h2>',
                html: 
							
							'<p class="mb-3 text-muted">Please do not refresh this page.</p>'+
							'<div>'+
								'<div class="pace-demo">'+
									'<div class="theme_xbox_lg">'+
										'<div class="pace_progress" data-progress-text="80%" data-progress="60"></div>'+
        ...
        // HTML message
        $('#sweet_download').on('click', function() {
            swal({
                title: '<h2>Downloading your details...</h2>',
                html: 
